...
$orientation = "horizontal";//(isset($_POST["orientation"])?$_POST["orientation"]:"horizontal");
$code_type = "code128";//(isset($_POST["codetype"])?$_POST["codetype"]:"code128");
$print = false;//(isset($_POST["print"])&&$_POST["print"]=='true'?true:false);
